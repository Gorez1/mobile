package ru.mirea.valuykin.notebook;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        @SuppressLint("SdCardPath") String pathh = "/data/data/com.example.notebook/files/fileName.txt";
    ...
    public void onSaveText(View view) throws IOException {
        ...
        @SuppressLint("SdCardPath") String path = "/data/data/com.example.notebook/files/"+fileName;
